def my_world_init( ip, port, grid_name, db_host, db_name, db_username, db_password ): #pasar los parametros que sea
...
ConnectionString = "Data Source={db_host};Database={db_name};User ID={db_username};Password={db_password};Old Guids=true;Allow Zero Datetime=true;"
...
[WifiService]
    ...
    HomeLocation = "{grid_name}/128/128/30"
